...
However, the photometric variability also increases


In this work we interchangably use the terms probability of observation of rotation, detectability of rotation period here.
The detectability of rotation period is dependent on a number of factors on a star to star basis


The detectability of rotation with fundamental stellar properties (temperature, metallicity etc.) has been previously investigated.
...
stars are more spot dominated the faster they are rotating. The rotational period gap is not the result of a transition.




Recent works to increase the rotational period detection sensitivity have increased the number of stars with observed rotation periods.

Stars surrounding the gap have uncharacteristically low \rper{}, despite their relatively fast rotation.
The probability of rotational detection drops with \rper{}, resulting in a decreased probability to observe stars near the rotatational period gap.
However, the decreased probability to 

While the number of stars surrounding the gap has increased,
However, increases to the detection efficiency have not yielded a larger sample of rotation periods of star with rotation periods that would place them within the intermediate period gap.

Very few works have analysed the properties distribution of stars without detected rotation in the \kepler{} sample.


The probability of observation of rotation of stars is expected to drop with decreased photometric variability - smaller variability amplitudes are harder to differentiate from noise.
The photometric variability of stars is dependent on the expression of stellar spots.
For two stars of the same colour, as magnetic field strength and thus the expression of stellar spots - in both size and number of expressed stellar spots - increases the photometric variability is expected to also increase.
The photometric variability also varies with the relative inclination of a stars rotational axis relative to the observer and the position of stellar spots on its surface.
A rotational axis (pole-on) star will not express any photometric variability as it rotates - despite expressing stellar spots - and as the angle between the rotational axis and the observation axis decreases a star will express larger photometric variability.
While stars are more likely to be equator on, we cannot discount the possibility that stars without detected rotational period, purely arise from the relative inclination of those stars.
As a result even that most active stars, in a spot coverage sense, will not have detectable rotation periods.
...
This suggests that there are no stars within the rotational period gap.



 used to determine the rotational period of \kepler{}
