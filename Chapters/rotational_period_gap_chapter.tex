...
The observed rotation period of stars is generally taken as the average rotation rate across the surface of the star, dependent on the distribution of spots on the stars surface.
...
\todo{citation needed}
Further, because the position of expressed spots on a stellar surface are stocastic, at different times different rotation periods can be observed.
if multiple significant peaks in the periodogram of the stellar lightcurve are observed then the scale of differential rotation can be measured.

\citet{reinhold_rotation_2013} measured performed this exact analysis.
They looked for multiple significant peaks in the periodogram of the lightcurve of \kepler{} stars.
...
Attributing these two periods to differential rotation they found that the relative shear increases with rotation period, and slightly decreases with effective temperature.

In this work, they differentiate between the two periods dependent on the significance of their peaks.
Comparing their recovered rotation periods to other works we observe that $P_1$ is generally taken as the average rotation rate of a star and $P_2$ is ignored.
The observation of a secondary rotation period is significant, however, as it allows us to place constraints on the scale of differential rotation of the star
Assuming a solar-like rotation profile, the greater, in terms of period, of these two peaks will be the rotation rate further away from the equator, while the smaller will closer reflect the rotation period closer to the equator.
...
If, for the example, a star is latitudinally
