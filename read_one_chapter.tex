...
\includeonly{Chapters/rotational_period_gap_chapter}
...
%             {\href{your web site or email address}{Tanner A. Wilson }}
%             {Tanner A. Wilson}
%             }
...
% \todo{Write shortened figure list names.}
...
% \rhead{\thepage}  % Sets the right side header to show the page number
% \lhead{}  % Clears the left side page header
% \input{Chapters/introduction_chapter} % Introduction

% \input{Chapters/subgiant_inversions_chapter}

% \input{Chapters/stellar_spot_metallicity_chapter}

\input{Chapters/rotational_period_gap_chapter} 

% \input{Chapters/conclusion_chapter}
